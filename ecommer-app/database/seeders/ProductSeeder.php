    ...
    public function run(): void
    {
        DB::table('products')->insert([
            [
                ...
                'slug' => str_replace(' ', '-', strtolower("Muffets Tuffets Burger")).'-'.'3'.time(),
                'category_id' => '1',
                'subcategory_id' => '1',
                'purchase_price' => '20',
                'sell_price' => '25',
                'calculation_price' => '25',
            ...
            [
                ...
                'slug' => str_replace(' ', '-', strtolower("Muffets Tuffets Pizza")).'-'.'3'.time(),
                'category_id' => '2',
                'subcategory_id' => '2',
                'purchase_price' => '50',
                'sell_price' => '85',
                'calculation_price' => '85',
                'description' => '<p>'.fake()->realText(200).'</p>',
                'additional_description' => '<p>'.fake()->realText(350).'</p>',
            ...
            [
                ...
                'slug' => str_replace(' ', '-', strtolower("Muffets Tuffets Meat")).'-'.'3'.time(),
                'category_id' => '3',
                'subcategory_id' => '3',
                'purchase_price' => '300',
                'sell_price' => '400',
                'calculation_price' => '400',
                'description' => '<p>'.fake()->realText(200).'</p>',
                'additional_description' => '<p>'.fake()->realText(350).'</p>',
