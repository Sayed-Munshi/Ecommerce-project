        ...
        <div class="col-lg-6 col-10">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('update.profile.info') }}" method="POST" class="theme-form theme-form-2 mega-form"
                        ...
                        <div class="row">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-12">
                                    <input id="photo" name="photo" class="form-control form-choose" type="file"
